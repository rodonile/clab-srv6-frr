...
declare -a CLIENT1_TESTS=(
  ...
  "PC12 PC11 ${PC_IPS[PC12_IPV4]} ${PC_IPS[PC11_IPV4]}"
  "PC12 PC11 ${PC_IPS[PC12_IPV6]} ${PC_IPS[PC11_IPV6]}"
)
declare -a CLIENT2_TESTS=(
  "PC21 PC22 ${PC_IPS[PC21_IPV4]} ${PC_IPS[PC22_IPV4]}"
  "PC21 PC22 ${PC_IPS[PC21_IPV6]} ${PC_IPS[PC22_IPV6]}"
  "PC22 PC21 ${PC_IPS[PC22_IPV4]} ${PC_IPS[PC21_IPV4]}"
  "PC22 PC21 ${PC_IPS[PC22_IPV6]} ${PC_IPS[PC21_IPV6]}"
)
